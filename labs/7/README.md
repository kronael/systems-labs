...
- [Validator state stream](1-validator-state-stream/README.md) — a system that
  ...
  staleness bound.
- [Settlement program and client](2-settlement-program-and-client/README.md) — an
...
- [Finality-aware transfer index](3-finality-aware-transfer-index/README.md) — a
  ...
  answer.
- [Reliable transaction dispatcher](4-reliable-transaction-dispatcher/README.md)
...
- [Permissionless application hosting](6-permissionless-application-hosting/README.md)
  — a system that publishes an application and delivers it to users with no
  server, domain, or account the publisher operates.
- [Multi-chain deposit service](7-multi-chain-deposit-service/README.md) — a
