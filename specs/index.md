...
| 09 | [Serverless quote aggregation](2/5-serverless-quote-aggregation.md) | The same quote product on functions | Admission as a platform ceiling, an expiry that outlives a freeze, state outside the process | Lambda runtime emulator, provider simulators, external store |
