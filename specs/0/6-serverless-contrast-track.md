...
- [`../01-systems-labs.md`](../01-systems-labs.md) — the contracts both phases
  inherit, and the execution-model carve-out to the no-ports rule.
- [`1-lab-selection.md`](1-lab-selection.md) — the original scored selection.
- [`5-shared-scaffold.md`](5-shared-scaffold.md) — the fault controller that
